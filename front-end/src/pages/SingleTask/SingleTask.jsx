			...
			<div className="task_card">
				{ task ?
					...
					>
						<DialogTitle id="alert-dialog-title">
							{"Do you want to confirm finishing the task? "}
						</DialogTitle>
						<DialogActions>
				...
				<div className="task_comment_zone">
					...
					<div className="task_addComment">
						...
						/>
						<SendIcon className="task_sendComment"  sx={{width:'15%', color:"#1976d2"}} onClick={sendComment}/>
					</div>
				</div>
			</div>
			<div className="task_returnButton">
				<Button variant="contained" onClick={()=>{navigate("/mytasks")}}>Back to Tasks</Button>
			</div>
		</>
	)
}